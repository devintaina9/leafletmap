  ...
  ionViewDidEnter() {
    ...
    const markerLocations: { coords: [number, number]; title: string; image: string; description: string }[] = [
      ...
      },
      {
        ...
        description: 'Umbul Jolotundo terletak di Jatinom, Kabupaten Klaten.'
      },
      {
        ...
        description: 'Rowo Jombor adalah waduk yang terletak di Klaten.'
      },
      {
        coords: [-7.608376104007904, 110.63526684445645],
        title: 'Umbul Ponggok',
        image: 'https://blog.tripcetera.com/id/wp-content/uploads/2020/08/image-5.png',
        description: 'Umbul Ponggok terletak di Desa Ponggok, Klaten.'
      },
      {
        ...
        description: 'Bukit Cinta Watu Prahu terletak di Bayat, Klaten.'
      }
    ];
